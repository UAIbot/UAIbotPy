...
PYBIND11_MODULE(uaibot_cpp_bind, m) {
  ...
  py::class_<Manipulator>(m, "CPP_Manipulator")
      ...
      .def("set_inertial_param",
           (void (Manipulator::*)(int, float, Vector3f, Matrix3f,
                                  bool))&Manipulator::set_inertial_param,
           py::arg("ind_link"), py::arg("mass"), py::arg("com_position"),
           py::arg("inertia_tensor"), py::arg("wrt_dh") = false)
      .def("newtonEuler", &Manipulator::newtonEuler, py::arg("q"),
           py::arg("q_dot"), py::arg("q_ddot"))
