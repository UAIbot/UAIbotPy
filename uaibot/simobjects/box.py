...
class Box:
  ...
  """
    ...
    def signed_distance(self, box2: "Box", gamma:float=1e-2, is_conservative: bool = True, mode: str ='auto') -> float:
        ...
        res = ub_cpp.distance_box2box(Utils.obj_to_cpp(self), Utils.obj_to_cpp(box2), gamma, is_conservative)
        return res
